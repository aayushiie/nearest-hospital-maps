function calculateHaversine(lat1, lon1, lat2, lon2) {
    ...
    const dLat = (lat2 - lat1) * Math.PI / 180; // degree to radian
...
async function findHospital(latitude, longitude, radius = 5000) {
    ...
    // version 1
    // const query = `[out:json][timeout:500];(node["amenity"="hospital"]["emergency"="yes"](around:${radius},${latitude},${longitude});way["amenity"="hospital"]["emergency"="yes"](around:${radius},${latitude},${longitude});relation["amenity"="hospital"]["emergency"="yes"](around:${radius},${latitude},${longitude}););out center;`;
    ...
    const query = `
        ...
        way["emergency"="yes"](around:${radius},${latitude},${longitude});
        relation["emergency"="yes"](around:${radius},${latitude},${longitude});
        );
        out center;
    `;
